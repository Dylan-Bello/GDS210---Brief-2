    ...
    public class GameManager_Test1 : MonoBehaviour
    {
        ...
        private void Update()
        {
           ...
           // Vector2 axisValues = SAE.ArcadeMachine.PlayerJoystickAxisStatic( ArcadeMachine.PlayerColorId.YELLOW_PLAYER );
            yellowPlayer.GetComponent<PlayerMovement>().AxisUpdate(SAE.ArcadeMachine.PlayerJoystickAxisStatic( ArcadeMachine.PlayerColorId.YELLOW_PLAYER ));
            bluePlayer.GetComponent<PlayerMovement>().AxisUpdate(SAE.ArcadeMachine.PlayerJoystickAxisStatic(ArcadeMachine.PlayerColorId.BLUE_PLAYER));
            ...
            if (SAE.ArcadeMachine.PlayerPressingButtonStatic(ArcadeMachine.PlayerColorId.BLUE_PLAYER, 0) == true)
            { Debug.Log("BLUE player pressed button 0 (Held down)"); }
